...
export default function Modules() {
    ...
    return (<div>
            ...
            <div className="card rounded-0">
                <ul id="wd-modules" className="list-group rounded-0">
                    {modules
                        ...
                        .map((module: any) => (<li
                                key={module._id}
                                className="wd-module list-group-item p-0 mb-3 fs-6 border-gray"
                            >
                                ...
                                {module.lessons && (<ul className="wd-lessons list-group rounded-0">
                                        {module.lessons.map((lesson: any) => (<li
                                                key={lesson._id}
            ...
            <div className="container-collapse-view">
                <button className="wd-collapse-all btn rounded-2 border-gray p-2">
                    Collapse All
                </button>
                <button className="wd-view-progress btn rounded-2 border-gray p-2">
                    View Progress
                </button>
            </div>
        </div>);
